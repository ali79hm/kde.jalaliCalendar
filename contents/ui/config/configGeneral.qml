...
// Kirigami.FormLayout {
//     id: page
//     property var calendar_type_list : ["gregorian", "Jalali(shamsi)",'ghamari']
//     property var calendar_type_list2 : [
//         { text: "gregorian", enabled: true },
//         { text: "Jalali(shamsi)", enabled: false},
//         { text: "ghamari", enabled: true}
//     ]
    
//     property var calendar_type_list3 : ListModel {
//         ListElement { key: "GE"; value: 'gegorian' }
//         ListElement { key: "JA"; value: 'Jalali(shamsi)' }
//         ListElement { key: "GA"; value: 'ghamari' }
//     }
...
//         // property int selectedFirstDropdownIndex: -1 // To store the index of the selected item in the first dropdown
//         // onCurrentIndexChanged: {
//         //     choosenIndex = currentIndex
//         //     selectedFirstDropdownIndex = firstCalendarDropdown.currentIndex
//         // }
//         model : calendar_type_list
//         // secondCalendarDropdown.currentIndex : -1

//     }

//     // function updateSecondDropdownModel() {
//     //     var firstCalendarDropdownIndex = firstCalendarDropdown.currentIndex
//     //     var secondCalendarDropdownModel = calendar_type_list.filter(function(value, index) {
//     //         return index !== firstCalendarDropdownIndex
//     //     })
//     //     secondCalendarDropdown.model = secondCalendarDropdownModel
//     //     secondCalendarDropdown.currentIndex = 0
//     //     // firstCalendarDropdown.model[firstCalendarDropdownIndex] == 
//     //     // if (firstCalendarDropdownIndex === secondCalendarDropdown.selectedFirstDropdownIndex) {
//     //     //     secondCalendarDropdown.currentIndex = -1
//     //     // }
//     // }
//     Component.onCompleted : {
//         console.log("===============================")
//         console.log(firstCalendarDropdown.model)
//         console.log(firstCalendarDropdown.currentIndex)
//         console.log(firstCalendarDropdown.model.get(firstCalendarDropdown.currentIndex).key)
//         console.log("===============================")
//     }
// }
