...
function getDaysInMonth(year, month) {
    // Hijri months have varying days; we use _hijriToJulianDay to compute
    const startDay = _hijriToJulianDay(year, month, 1);
    const nextMonthStart = _hijriToJulianDay(year, month + 1, 1);
    return nextMonthStart - startDay; // The difference gives the number of days in the month
}
...
function _hilalIM(country = 'IR') {
    return {
        IR: {
            ...
            endYear: 1449, /* =iDoM:lastYear */
            endJD: 2461616, /* =_hijriAToJulianDay(endYear+1,1,1)-1 */
            ...
            iDoM: { // islamicYear: [Sum, m1, ..., m12],
                ...
                1446: [355, 30, 30, 30, 29, 30, 30, 29, 30, 29, 29, 29, 30], /* :1403_Official_Iranian_Calendar and Temporary_1404: */
                1447: [354, 29, 30, 30, 29, 30, 30, 30, 29, 30, 29, 29, 29],
                1448: [355, 30, 29, 30, 29, 30, 30, 29, 30, 30, 29, 30, 29],
                1449: [354, 30, 29, 29, 30, 29, 30, 29, 30, 30, 30, 29, 29],
